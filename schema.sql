...
INSERT INTO
    public.treats (sku, name, satiety, price)
VALUES
...
INSERT INTO
    public.evolution_stages (stage, max_happiness, max_hunger)
VALUES
    (1, 100, 100),
    (2, 500, 500),
    (3, 1000, 1000); 
...
INSERT INTO
    public.creature_types (type, fav_treat, hated_treat)
VALUES
...
INSERT INTO
    public.creatures (id, name, type, happiness, hunger)
VALUES
